        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartipantsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventUser", x => new { x.JoinedEventsId, x.PartipantsId });
                    table.ForeignKey(
                        name: "FK_EventUser_AspNetUsers_PartipantsId",
                        column: x => x.PartipantsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
